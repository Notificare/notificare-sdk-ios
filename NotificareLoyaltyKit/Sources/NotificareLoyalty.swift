...
public class NotificareLoyalty: NSObject, NotificareModule {
    public static let shared = NotificareLoyalty()
    ...
    public static func configure() {
        ...
        NotificationCenter.default.addObserver(NotificareLoyalty.shared,
