...
struct InboxPushAPIModels {
    @Test
    func testRemoteInboxItemToModel() {
    ...
    @Test
    func testRemoteInboxItemWithNullPropsToModel() {
        let expectedItem = NotificareInboxItem(
            id: "testId",
            notification: NotificareNotification(
                partial: true,
    ...
    func assertItem(expectedItem: NotificareInboxItem, item: NotificareInboxItem) {
