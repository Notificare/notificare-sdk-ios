...
struct NotificareUserInboxItemTest {
    @Test
    func testNotificareUserInboxSerialization() {
    ...
    @Test
    func testNotificareUserInboxSerializationWithNullProps() {
        let item = NotificareUserInboxItem(
            id: "testId",
            notification: NotificareNotification(
                partial: true,
    ...
    func assertItem(item: NotificareUserInboxItem, convertedItem: NotificareUserInboxItem) {
