...
SWIFT_CLASS("_TtC17NotificarePushKit14NotificarePush")
@interface NotificarePush : NSObject
...
@interface NotificarePush (SWIFT_EXTENSION(NotificarePushKit)) <UNUserNotificationCenterDelegate>
